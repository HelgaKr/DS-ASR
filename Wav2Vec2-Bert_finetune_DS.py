...
MODEL_CHECKPOINT = "facebook/w2v-bert-2.0"

BATCH_SIZE = 8
GRADIENT_ACCUMULATION_STEPS = 2
NUM_EPOCHS = 30
LEARNING_RATE = 3e-5                       # This learning rate showed the best results for our corpus
WARMUP_STEPS = 1000
SAVE_STEPS = 500
LOGGING_STEPS = 50
...
#NOTE: Uncomment this part to try layer freezing
# Freeze adapter and feature projection layers
#for param in model.wav2vec2_bert.adapter.parameters():
