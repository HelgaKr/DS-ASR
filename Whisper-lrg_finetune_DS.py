...
REPO_NAME = "./whisper-lrg"                # Name for saving model
MODEL_CHECKPOINT = "openai/whisper-large"

BATCH_SIZE = 32
GRADIENT_ACCUMULATION_STEPS = 1
NUM_EPOCHS = 5                            
LEARNING_RATE = 1e-5                       # This learning rate showed the best results for our corpus
WARMUP_STEPS = 50
...
# NOTE: Uncomment the following lines to freeze the encoder:
#
